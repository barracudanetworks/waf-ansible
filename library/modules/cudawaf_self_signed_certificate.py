...
short_description: Manages self signed certificates on Barracuda WAF
version_added: 2.10
description:
    - This module can be used to manage the servers created under the services on the Barracuda WAF.
