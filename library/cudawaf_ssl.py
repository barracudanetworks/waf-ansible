...
short_description: Manages SSL configuration for the services on Barracuda WAF
version_added: 2.10
description:
    - This module can be used to manage the SSL configuration for the services on the Barracuda WAF.
