...
short_description: Manages configuration export in JSON format on Barracuda WAF
version_added: 2.10
description:
    - This module can be used to export the configuration in JSON format on the barracuda WAF.
